...
import com.beanBoi.beanBoiBackend.beanBoiBackend.models.Recipe;
...
public class testRecipeRepository extends TestUtils {
    ...
    public void testSaveRecipe() {
        ...
        {assertEquals(getTestEspressoRecipeMap().get(key).toString(), firestore.getDocument(recipeRepository.collectionName, id).get(key).toString());});
    }
